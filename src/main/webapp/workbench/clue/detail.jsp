...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#activityName").keydown(function (event){
			if(event.keyCode == 13){
				$.ajax({
					url:"workbench/clue/getActivityByNameExcept.do",
					data:{
...
<%--							</tr>--%>
	...
	<div style="position: relative; top: 40px; left: 40px;">
		...
		<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>重复功能</h5>
				<font color="gray">线索</font> <font color="gray">-</font> <b>LCH-NCEPU</b> <small style="color: gray;"> 2021-3-23 10:10:10 由lch</small>
		...
		<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>未做实现</h5>
				<font color="gray">线索</font> <font color="gray">-</font> <b>LCH-NCEPU</b> <small style="color: gray;"> 2021-3-23 10:20:10 由lch</small>
				<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
					<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
